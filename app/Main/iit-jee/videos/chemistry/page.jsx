...
const Page = () => {
  ...
  const filteredFiles = files.filter(file => {
    ...
    const isIITJEE = file.course.trim().toLowerCase() === 'iit-jee';
  ...
  return (
    <div>
      <div className="flex items-center justify-center mt-4">
        ...
        <h1 className="ml-2 font-semibold text-md absolute  mt-4 left-16 hidden md:flex">Videos</h1>
        <span className="mr-2 ml-2 border text-xl rounded-md  mt-4 p-2">
          <IoSearch />
        </span>
        <Input
          placeholder='Search...'
