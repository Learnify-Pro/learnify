...
const Page = () => {
  ...
  const filteredFiles = files.filter(file => {
    ...
    const excludeTags = ["zoology", "botany", "biology"];
    const shouldExclude = excludeTags.some(tag => tags.includes(tag));

    return institutionMatch && subjectMatch && searchMatch && !shouldExclude;
  });
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center mt-4">
        <Link href='/Main/iit-jee' className="mr-2 hidden md:flex ml-2 absolute left-8 border text-xl rounded-md p-2">
          <FaArrowLeft />
        </Link>
