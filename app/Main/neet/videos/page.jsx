...
const page = () => {
  const data = [
    { label: "Zoology", desc: "Get All Zoology Videos On One Click", link: "/Main/neet/videos/zoology", icon: < FaPlay /> },
    { label: "Botany", desc: "Get All Botany Videos On One Click", link: "/Main/neet/videos/botany", icon: < FaPlay /> },
    { label: "Physics", desc: "Get All Physics Videos On One Click", link: "/Main/neet/videos/physics", icon: < FaPlay /> },
    { label: "Chemistry", desc: "Get All Chemistry Videos On One Click", link: "/Main/neet/videos/chemistry", icon: < FaPlay /> },
  ]
  return (
