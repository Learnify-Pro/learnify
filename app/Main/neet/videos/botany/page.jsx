...
const Page = () => {
  ...
  const fetchFiles = async () => {
    ...
    const mathFiles = filesList.filter(file => file.subject === 'BOTANY');
    setFiles(mathFiles);
    setLoading(false);
  };
  useEffect(() => {
  ...
  return (
    <div>
      <div className="flex items-center justify-center mt-4">
        <button className="border p-2 absolute left-4 rounded-md  mt-4 text-md hidden md:flex" onClick={handleBackClick}>
          <FaArrowLeft />
        </button>
