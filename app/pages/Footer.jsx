...
const Footer = () => {
  ...
  const ResourceLink = [
    {title:"Physics Wallah",link:'/'},
    {title:"Infinty Learn",link:'/'},
    {title:"Offical Websites ",link:'/'},
    {title:"MathonGo",link:'/'},
    {title:"Unacademy",link:'/'},
    {title:"Aakash",link:'/'},
    ...
    <div>
      ...
      <footer className="bg-white">
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          >
            <strong className="text-xl text-white sm:text-xl"> Make Prepartion Fast ! </strong>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                {
                  footerLinks.map((item, i) => (
                    <li key={i} className='flex'>
                      <Link className="text-gray-700 transition hover:text-gray-700/75" href={item.link}>
          ...
          <div className="mt-16">
            ...
            <div className="mt-16 sm:flex sm:items-center sm:justify-between">
              <div className="flex justify-center text-teal-600 sm:justify-start">
                <Link href='/'>
                   <Image src='/Logo.png' alt='logo' height={100} width={250}></Image>
                </Link>
              </div>
